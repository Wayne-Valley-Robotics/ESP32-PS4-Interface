...
Use an ESP32 to connect to and take inputs from a PS4 controller, then transmit that data over serial using the SerialTransfer library.
...
This project uses the PlatformIO plugin for VSCode.
